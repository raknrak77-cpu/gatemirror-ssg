...
def delete_folder(prefix):
    ...
    while True:
        ...
        if 'Contents' not in response:
            print(f"   ⚠️ Klasör bulunamadı veya boş: {prefix}")
            break
...
def delete_required_folders():
    print("\n" + "="*60)
    print("🗑️ SİLME BOTU - Belirtilen klasörler siliniyor")
    print("="*60)
    
    folders = ["category-archive/", "de/", "fr/", "es/"]
    ...
    print("\n" + "="*60)
    print("✅ Tüm belirtilen klasörler R2'den silindi.")
    print("="*60)

if __name__ == "__main__":
    delete_required_folders()
