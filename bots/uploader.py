...
def upload_svg_patterns():
    ...
    svg_files = [
        ("assets/all-patterns/spiral_out/spiral_circular_medium_11.svg.svg", "assets/svg1.svg"),
        ("assets/all-patterns/spiral_out/spiral_circular_basic_8.svg", "assets/svg2.svg"),
    ]
