...
def upload_svg_patterns():
    ...
    svg_files = [
        ("assets/all-patterns/spiral_out/spiral_circular_medium_10.svg", "assets/svg1.svg"),
        ("assets/all-patterns/spiral_out/spiral_circular_basic_06.svg", "assets/svg2.svg"),
    ]
